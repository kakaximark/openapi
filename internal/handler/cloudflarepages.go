...
// @Router       /api/v1/cloudflare/pages/projects [get]
func GetPagesProjectHandler(c *gin.Context) {
	// 从上下文中获取已验证的请求头信息
	...
	resp, err := service.GetPagesProject(headers.CountryCode, headers.Env)
	if err != nil {
